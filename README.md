...
* **Blazing fast power scheduling** to prioritize fuzzing on code that are more likely to have bugs.
...
| Arrow | Incorrect posiition logic leading to fund loss | Found in Audit |

ItyFuzz can generate exploit for >80% previous hacks automatically without any knowledge of the hack. 
